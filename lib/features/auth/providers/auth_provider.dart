...
class AuthNotifier extends StateNotifier<AuthState> {
  ...
  Future<void> _initialize() async {
    ...
    _authSubscription =
      ...
      try {
        ...
        // Stamp isGoogleUser onto the resolved AppUser
        final resolvedUser = userData.copyWith(isGoogleUser: isGoogleUser);
  ...
  Future<void> signInWithGoogle() async {
    ...
    try {
      ...
      // Always mark Google users
      final resolvedUser = result.user.copyWith(isGoogleUser: true);
