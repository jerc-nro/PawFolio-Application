    ...
    return Scaffold(
      ...
      body: archivedPetsAsync.when(
        ...
        data: (allPets) {
          ...
          // ── Sort: archived-alive first (latest added), deceased last ──
          final archived = filtered.where((p) =>  p.isAlive).toList();
          final deceased = filtered.where((p) => !p.isAlive).toList();
          final pets = [...archived, ...deceased];
