...
class VaccinationHistoryView extends ConsumerWidget {
    ...
    if (confirm) {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
            content: Text("Vaccination record archived"),
              ...
              : () => Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (_) => ArchivedRecordsPage(
                          pet: pet,
                          uid: uid,
                          config: vaccinationArchiveConfig))),
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasError) {
          debugPrint('Vaccinations error: ${snapshot.error}');
        ...
        // For ALL filter, still exclude archived client-side
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return _vaccinationItem(context, ref,
              ...
              name: extra['vaccine_name'] ??
                  data['vaccine_name'] ?? 'Core Vaccine',
              type: extra['vaccine_type'] ??
                  data['vaccine_type'] ?? 'General',
  ...
  Widget _vaccinationItem(BuildContext context, WidgetRef ref, {
    ...
    required String time, required String clinic, required String vet,
  }) {
    Color statusColor;
    switch (status) {
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start,
        ...
        Row(children: [
          Expanded(child: _infoTile("ADMINISTERED", date,
              icon: Icons.calendar_today)),
          Expanded(child: _infoTile("TIME", time,
