...
final preventativeFilterProvider = StateProvider.autoDispose<String>((ref) => "ALL");
...
class PreventativesHistoryView extends ConsumerWidget {
              ...
              child: Padding(
                ...
                child: Column(children: [
                  ...
                  StatusFilterRow(
                    ...
                    onStatusSelected: (s) =>
                        ref.read(preventativeFilterProvider.notifier).state = s,
                  ),
                  const SizedBox(height: 10),
  ...
  void _handleEdit(BuildContext context, String uid, String docId,
    ...
    showEditRecordDialog(context,
        ...
        config: preventativeEditConfig, existingData: data);
  }
  ...
  void _handleArchive(BuildContext context, WidgetRef ref, String docId) async {
    ...
    if (confirm) {
      await ref.read(recordControllerProvider.notifier).archiveRecord(
          petId: pet.petID, collection: 'preventatives', recordId: docId);
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text("Preventative record archived")));
      }
    }
  }
    ...
    return Row(
      ...
      children: [
        GestureDetector(
          onTap: uid == null ? null : () => Navigator.push(context,
              MaterialPageRoute(builder: (_) => ArchivedRecordsPage(
                  pet: pet, uid: uid, config: preventativeArchiveConfig))),
        ...
        if (pet.isArchived)
          ...
          ElevatedButton.icon(
            onPressed: () =>
                showAddPreventativeDialog(context, pet.petID, pet.name, pet.type),
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return _preventativeItem(context, ref,
              ...
              brand: extra['brand_name'] ?? data['brand_name'] ?? 'Generic',
  ...
  Widget _preventativeItem(BuildContext context, WidgetRef ref, {
    ...
    required String brand, required String type, required String status,
    required String date, required String time, required String dosage,
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          Expanded(child: _infoTile("SCHEDULED DATE", date, icon: Icons.calendar_today)),
          Expanded(child: _infoTile("INTAKE TIME", time, icon: Icons.access_time)),
        ]),
  ...
  Widget _buildHeader(BuildContext context) => Padding(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          const Text("PREVENTATIVES", style: TextStyle(fontSize: 20,
