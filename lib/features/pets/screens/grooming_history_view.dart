    ...
    if (confirm) {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
            content: Text("Grooming record archived"),
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasError) {
          debugPrint('Grooming error: ${snapshot.error}');
          return Center(child: Text("Error: ${snapshot.error}"));
        }
        if (snapshot.connectionState == ConnectionState.waiting) {
          return const Center(
              child: CircularProgressIndicator(color: navBlue));
        }
            ...
            child: Column(
              ...
              children: [
                Icon(Icons.event_note_outlined,
                    size: 50,
                    color: navBlue.withValues(alpha: 0.3)),
                const SizedBox(height: 10),
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return _groomingItem(context, ref,
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start,
        ...
        Row(children: [
          ...
          Expanded(child: _infoTile("PROVIDER", provider,
