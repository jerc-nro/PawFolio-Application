...
class VetVisitsHistoryView extends ConsumerWidget {
    ...
    if (confirm) {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
            content: Text("Vet visit record archived"),
    ...
    return Row(
      ...
      children: [
        ...
        if (pet.isArchived)
          ...
          ElevatedButton.icon(
            onPressed: () => showAddVetVisitDialog(
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasError) {
          debugPrint('Vet visits error: ${snapshot.error}');
  ...
  Widget _visitItem(BuildContext context, WidgetRef ref, {
    ...
    required String reason, required String clinic,
    required String vet, required String date,
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start,
        ...
        Row(children: [
          Expanded(child: _infoTile("VISIT DATE", date,
              icon: Icons.calendar_today)),
          Expanded(child: _infoTile("VISIT TIME", time,
      ...
      Row(
        ...
        children: [
          if (icon != null)
            Icon(icon,
                size: 15,
                color: navBlue.withValues(alpha: 0.6)),
