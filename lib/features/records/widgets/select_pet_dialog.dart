...
// CHANGED: Converted to ConsumerStatefulWidget to use initState
    ...
    return Dialog.fullscreen(
      ...
      child: SafeArea(
        child: Column(
          ...
          children: [
            // Pass isAddMode to header to update text
            _DialogHeader(
            ...
            PetSearchBar(
              onChanged: (val) => ref.read(petSearchQueryProvider.notifier).set(val),
            ),
            ...
            Expanded(
              child: filteredPetsAsync.when(
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return PetCard(
                        pet: pet,
                        onTap: () {
                          // This helper uses isAdd to decide whether to push 
                          // the history list or the add record form directly.
                ...
                loading: () => const Center(
                  child: CircularProgressIndicator(color: RecordsPalette.steel)
                ),
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.pets,
              size: 48, color: RecordsPalette.muted.withOpacity(0.35)),
          const SizedBox(height: 12),
          const Text(
            'No pets found.',
            style: TextStyle(color: RecordsPalette.muted, fontSize: 15),
          ),
        ],
      ),
    );
